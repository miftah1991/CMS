            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-responsive ">
                        ...
                        <tr>
                            <td>
                                <span class="fa  fa-eyedropper fa-lg btn btn-default"></span>موضوع ګزارش
                            </td>
                            <td>
                                {{$data->Subject}}
                            </td>
                            <td>
                                <span class="fa  fa-code btn btn-default fa-lg"></span>      فایل ګزارش
                            </td>
                            <td>
                                <a href="{{asset('storage/app/public/Contract_Report')}}/{{$data->Report_File}}" ><span class="fa fa-download"></span></a>
                            </td>
                        </tr>
                    </table>
                </div>
