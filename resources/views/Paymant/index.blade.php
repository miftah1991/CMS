...
<div class="col-lg-12 ">
    ...
    <div class="panel panel-danger ">
        <div class="panel-heading">
            <div class="panel-title text-center"> ثپت اجناس پروژه</div>
                ...
                <div class="col-lg-12">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="Details" id="Details" autocomplete="off" required class="form-control myfont " >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number"  name="Qunity"   id="Qunity" required autocomplete="off" class="form-control MulQuntity myfont " >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="Unit_Price"   id="Unit_Price" required autocomplete="off" class="form-control myfont  MulQuntity " >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="Total_Price" readonly id="Total_Price" required autocomplete="off" class="form-control MulQuntity  myfont" >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="Discount"  id="Discount" max="100" autocomplete="off" readonly class="form-control MulQuntity myfont " >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" readonly name="Amount" id="Amount" required autocomplete="off" class="form-control MulQuntity myfont " >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="Price_Distcount" readonly required id="Price_Distcount" class="form-control MulQuntity myfont " >
...
<div class="panel-footer">
    ...
    <input type="button" value=" ثپت کردن" id="btn_save" class="btn btn-primary">
        ...
        $('#Pro_Fid').on('change',function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                 ...
                 if(response)
                 {
                     alert('این پروژه تکمیل است ')
                     $("#btn_save").attr('disabled','ture');
                 }
                 else
                 {
            ...
            $("#tblesubinvoice").empty();
                ...
                success: function (data) {
                    ...
                    for( i=0;i<data.length;i++)
                    {
                        ...
                        tr+='<tr class="myfont"><td>'+(++number)+'</td><td style="font-size:12px; ">'+data[i].Details+'</td><td>'+data[i].Qunity+'</td><td>'+data[i].Unit_Price+'</td><td>'+data[i].Amount+'</td><td>'+data[i].Total_Price+'</td><td>'+data[i].Discount+'</td><td>'+data[i].Price_Distcount+'</td><td><a href="{{url('Edit_Paymany')}}/'+data[i].id+'"   class="btn btn-xs btn-success"  ><i  class="fa fa-pencil"></i></a></td></tr>';
                     ...
                     $('#Save_Date').val('');
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                {
                                    console.log(data[i].Amount);
                                    tr+='<tr class="myfont" ><td>'+(++number)+'</td><td>'+data[i].Details+'</td><td>'+data[i].Qunity+'</td><td>'+data[i].Unit_Price+'</td><td>'+data[i].Amount+'</td><td>'+data[i].Total_Price+'</td><td>'+data[i].Discount+'</td><td>'+data[i].Price_Distcount+'</td><td><a href="{{url('Edit_Paymany')}}/'+data[i].id+'"   class="btn btn-xs btn-success"  ><i  class="fa fa-pencil"></i></a></td></tr>';
