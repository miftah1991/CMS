...
<div class="col-lg-12 ">
    ...
    <div class="panel panel-danger ">
        ...
        <form action="{{url('Add_Fouder')}}"  method="post"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        <label>اسم تطمویل کننده</label>
                        <div class="input-group {{ $errors->has('FouName') ? 'has-error' : ''}}">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>

                            <input type="text" name="FouName" id="FouName"   required  autocomplete="off" class="form-control "  >
