...
<div class="col-lg-12 ">
    ...
    <div class="panel panel-danger ">
        ...
        <div class="panel-heading">
            <div class="panel-title text-center">تنظمات نوع کار حسبا</div>
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group {{ $errors->has('Role_Name') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="Role_Name" id="Role_Name"   required  autocomplete="off" class="form-control "  >
...
<div class="panel-footer">
    ...
    <input type="submit" value=" ثپت کردن" id="btnsave" class="btn btn-primary">
        ...
        <div class="panel panel-primary ">
            ...
            <div class="panel-heading">
                <div class="panel-title text-center" >لیست کاربران حساب</div>
