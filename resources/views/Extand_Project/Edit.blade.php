...
<div class="col-lg-12 ">
    ...
    <div class="panel panel-danger ">
        ...
        <div class="panel-heading">
            <div class="panel-title text-center">تغیر کردن تعدیلات قرارداد</div>
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group {{ $errors->has('Ext_Fid') ? 'has-error' : ''}}">
                         ...
                         <input type="text" class="form-control"  name="Ext_Fid" value="{{$data->Ext_Fid}}">
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group {{ $errors->has('End_Date') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="End_Date" id="End_Date" value="{{$data->End_Date}}" autocomplete="off" class="form-control myfont "  >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group  {{ $errors->has('time') ? 'has-error' : ''}}">
                            ...
                            <input type="time" name="time"  value="{{$data->time}}" class="form-control "  >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group {{ $errors->has('place') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="place" value="{{$data->Place}}" class="form-control " >
