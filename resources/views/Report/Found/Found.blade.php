                        ...
                        <div class="col-lg-6" style="background-color:wheat;margin-top: 4px;">
                            <div class="info-box" style="margin-top: 4px;">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <div class="col-md-6 text-center"><span class="info-box-text" >  دالر   </span><span class="badge bg-aqua"  id="Total_Dabs_DA">dd</span>
                                    </div>
                                    <div class="col-md-6 text-center "><span class="info-box-text" >  افغانی   </span><span class="badge bg-aqua"  id="Total_Dabs_AF">dd</span>
                                    </div>
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <div class="col-md-6 text-center"><span class="info-box-text" >  دالر   </span><span class="badge bg-green"  id="totalitem">dd</span>
                                    </div>
                                    <div class="col-md-6 text-center "><span class="info-box-text" >  افغانی   </span><span class="badge bg-green"  id="totalitem">dd</span>
                                    </div>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <div class="col-md-6 text-center"><span class="info-box-text" >  دالر   </span><span class="badge bg-red"  id="totalitem">dd</span>
                                    </div>
                                    <div class="col-md-6 text-center "><span class="info-box-text" >  افغانی   </span><span class="badge bg-red"  id="totalitem">dd</span>
                                    </div>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
