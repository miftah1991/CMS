    ...
    <form method="POST"  action="{{url('Add_Persantage')}}" id="upload_image_form" enctype="multipart/form-data"   >
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group ">
                        <label>شماره ګرنتی</label>
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>

                            <input type="text" name="Warrenty_Number"  id="Warrenty_Number" class="form-control">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="form-group ">
                        <label>تاریخ اغاز تضمین</label>
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>

                            <input type="text" name="Start_Date_Tazmin" id="Start_Date_Tazmin" autocomplete="off" class="form-control myfont " >
                ...
                <div class="col-lg-3">
                    <div class="form-group ">
                        <label>تاریخ ختم تضمین</label>
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>

                            <input type="text" name="End_Date_Tazmin" id="End_Date_Tazmin" class="form-control">
    ...
    $(document).ready(function () {
        ...
        $('#Pro_Fid').on('change',function () {
            ...
            $.ajax({
                ...
                url: '{{url('Find_Contract_Rupee')}}',
                method: 'get',
                data: {id: val},
                success: function (response) {


                    $('#Amount').val(response.Contract_Rupee);
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    for(var i=0;i<data.length;i++)
                    {
                        ...
                        {
                            tr+='<tr style="text-align: center" class="myfont"><td>'+(++n)+'</td><td>'+data[i].Per_Name+'</td><td>'+data[i].Date+'</td><td>'+data[i].Persantage+ '%'+'</td><td>'+data[i].Amount+'</td><td>'+data[i].Net_Amount+'</td><td><a href="{{asset('storage/app/public/Perstange')}}/'+data[i].warrenty+'" ><span class="fa fa-download"></span></a> </td><td><span style="color:red" class="fa fa-battery-1"></span></td><td><a href="Delete_Persantage\\'+ data[i].id+'"><span class="btn btn-danger"></span></a> </td></tr>' ;

                        }
                        else
                        {
                            tr+='<tr style="text-align: center" class="myfont"><td>'+(++n)+'</td><td>'+data[i].Per_Name+'</td><td>'+data[i].Date+'</td><td>'+data[i].Persantage+ '%'+'</td><td>'+data[i].Amount+'</td><td>'+data[i].Net_Amount+'</td><td><a href="{{asset('storage/app/public/Perstange')}}/'+data[i].warrenty+'" ><span class="fa fa-download"></span></a> </td><td><span style="color:green" class="fa fa-check-square-o"></span></td><td><a href="Delete_Persantage\\'+ data[i].id+'"><span class="btn btn-danger"></span></a> </td></tr>' ;
        ...
        $('#Start_Date_Tazmin').persianDatepicker({
            formatDate: "YYYY-0M-0D"
        });

        $('#End_Date_Tazmin').persianDatepicker({
            formatDate: "YYYY-0M-0D"
        });
