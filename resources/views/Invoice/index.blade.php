                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="Save_Date" id="Save_Date" required autocomplete="off" class="form-control myfont " >
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="file" name="Check_Invvoice_File"  class="form-control " >
                ...
                <div class="col-lg-3">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="Amount_Invoice" min="1" id="Amount_Invoice" required class="form-control myfont " >
                ...
                <div class="col-lg-3">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="Accepts_Fund" id="Accepts_Fund" readonly required class="form-control myfont " >
                ...
                <div class="col-lg-3">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="Persantage" id="Persantage" readonly required class="form-control myfont " >
                ...
                <div class="col-lg-3">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="Date_Accept" id="Date_Accept"  required class="form-control myfont " >
        ...
        $('#Pro_Fid').on('change',function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#Accepts_Fund').val(response.Contract_Rupee);
