...
<div class="col-lg-12 ">
    ...
    <div class="panel panel-danger ">
        ...
        <form action="{{url('Insert_Email_Eval_Time')}}" method="post">
            @csrf
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                <select name="type" id="type" class="form-control">
                                    ...
                                    <option  value="3">ارسال ایمیل به هیات ارزیابی </option>
                                    <option  value="4">ارسال ایمیل تعقیبی به هیت ارزیابی </option>
