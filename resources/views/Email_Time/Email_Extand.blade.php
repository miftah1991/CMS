...
<div class="col-lg-12 ">
    ...
    <div class="panel panel-danger ">
        <div class="panel-heading">
            <div class="panel-title text-center">ارسال ایمل  هیت تعدیل قرارداد</div>

        </div>

        <form action="{{url('Insert_Mail_Extand')}}" method="post">
            @csrf
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                <select name="type" id="type" class="form-control">
                                    ...
                                    <option  value="7">اطلاع ایمیل  به هیت تعدیل قرارداد  </option>
                                    <option  value="8">ارسال ایمیل تعقیبی به هیت تعدیل قرارداد </option>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group {{ $errors->has('Day') ? 'has-error' : ''}}">
                            ...
                            <select id="Day" name="Day"  required class="form-control  ">
                                <option  value="">لطفا مدت انتخاب کنید</option>
