...
<br> <br>
<form action="{{url('Update_Accept_Project')}}" method="post" enctype="multipart/form-data" >
    @csrf
    <div class="panel panel-info ">
        <div class="panel-heading">
           ...
           <input type="hidden" name="id" value="{{$data->id}}">
            <input type="hidden" name="Pro_Fid" value="{{$register->id}}">
                ...
                <div class="col-lg-4">
                    <div class="form-group ">
                        ...
                        <div class="input-group {{ $errors->has('Accept_Date') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="Accept_Date" value="{{$data->Accept_Date}}" id="Accept_Date" autocomplete="off" required class="form-control " >
